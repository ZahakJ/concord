...
<div class="ds-scrim" role="presentation" onclick={onClose} use:portal></div>
<div class="ds" role="dialog" use:portal aria-label="Choose what you wear on your avatar">
  <div class="ds-head">
