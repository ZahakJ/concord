...
export const api = {
  ...
  setProfile: (name, status, emoji, color, avatar, banner = "", presence = "", bio = "", color2 = "", frame = "", effect = "") =>
    call("SetProfile", name, status, emoji, color, avatar, banner, presence, bio, color2, frame, effect),
