...
export const SHORTCUTS = [
  { group: "Navigation", chords: [["Ctrl/⌘", "K"]], label: "Command palette" },
  ...
  { group: "Navigation", chords: [["Alt", "Shift", "↑"], ["Alt", "Shift", "↓"]], label: "Unread channel" },
  { group: "Navigation", chords: [["Ctrl", "Alt", "↑"], ["Ctrl", "Alt", "↓"]], label: "Previous / next guild" },
  { group: "Navigation", chords: [["Ctrl/⌘", "U"]], label: "Member panel" },
  { group: "Navigation", chords: [["Ctrl/⌘", "="], ["Ctrl/⌘", "-"], ["Ctrl/⌘", "0"]], label: "Zoom" },
  { group: "Navigation", chords: [["?"], ["Ctrl/⌘", "/"]], label: "This list" },

  { group: "Reading", chords: [["Esc"]], label: "Close, or mark channel read" },
  { group: "Reading", chords: [["Shift", "Esc"]], label: "Mark everything read" },

  { group: "Voice", chords: [["Ctrl", "Shift", "M"]], label: "Mute" },
  { group: "Voice", chords: [["Ctrl", "Shift", "D"]], label: "Deafen" },
  { group: "Voice", chords: [["your own key"]], label: "Push to talk" },

  { group: "Composer", chords: [["Enter"]], label: "Send" },
  { group: "Composer", chords: [["Shift", "Enter"]], label: "New line" },
  { group: "Composer", chords: [["↑"]], label: "Edit last message" },
  { group: "Composer", chords: [["Ctrl/⌘", "Shift", "L"]], label: "Text direction" },

  { group: "Format", chords: [["Ctrl/⌘", "B"]], label: "Bold" },
  { group: "Format", chords: [["Ctrl/⌘", "I"]], label: "Italic" },
  { group: "Format", chords: [["Ctrl/⌘", "E"]], label: "Inline code" },
  { group: "Format", chords: [["Ctrl/⌘", "Shift", "U"]], label: "Underline" },
  { group: "Format", chords: [["Ctrl/⌘", "Shift", "S"]], label: "Strikethrough" },
  { group: "Format", chords: [["Ctrl/⌘", "Shift", "K"]], label: "Link" },
  { group: "Format", chords: [["Ctrl/⌘", "Shift", "X"]], label: "Spoiler" },
  { group: "Format", chords: [["Ctrl/⌘", "Shift", "."]], label: "Quote" },

  { group: "Slash commands", typed: true, chords: [["/shrug"], ["/me"], ["/spoiler"], ["…"]], label: "Commands" },

  { group: "Markdown", typed: true, chords: [["**text**"]], label: "Bold" },
  { group: "Markdown", typed: true, chords: [["*text*"]], label: "Italic" },
  { group: "Markdown", typed: true, chords: [["__text__"]], label: "Underline" },
  { group: "Markdown", typed: true, chords: [["~~text~~"]], label: "Strikethrough" },
  { group: "Markdown", typed: true, chords: [["||text||"]], label: "Spoiler" },
  { group: "Markdown", typed: true, chords: [["`code`"], ["```block```"]], label: "Code" },
  { group: "Markdown", typed: true, chords: [["> "], [">>> "]], label: "Quote (line / rest)" },
  { group: "Markdown", typed: true, chords: [["# "], ["## "], ["### "]], label: "Headers" },
  { group: "Markdown", typed: true, chords: [["[text](url)"]], label: "Masked link" },
];
